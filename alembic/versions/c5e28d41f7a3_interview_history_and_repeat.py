...
def upgrade() -> None:
    ...
    op.create_index("conversations_created_at_idx", "conversations", ["created_at"])


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index("conversations_created_at_idx", table_name="conversations")
    op.drop_constraint("conversations_repeat_of_id_fkey", "conversations", type_="foreignkey")
